...
def main():
    ...
    if clearP.is_dir() and depthP.is_dir():
        ...
        for imgf in image_files:
            print(("-".join(imgf.name.split('-')[:2])+".npy"))
        print(f'path depth: {Path(depthP)}')
